...
#A1: According to the Spearman correlation, none of the variable pairs had a greater correlation coefficient than abs(0.19). Some of the variables, particularly % primary tree species and % secondary tree species do look colinear on the plots, but apparently not enough to matter. 
...
# A2: I do not see much positivie spatial auto-correlation. The only scale at which I would be concerned is under 700 meters. 
...
#A3: The QQ plots look good. The residuals vs predicted plots also look fine.
